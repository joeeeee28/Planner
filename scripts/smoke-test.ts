...
async function main() {
  const cases: { name: string; url: string; stored: string | null }[] = [
    ...
    { name: 'onboarded, /money/overview', url: 'https://joeeeee28.github.io/Planner/#/money/overview', stored: '{"onboarded":true}' },
    { name: 'onboarded, /money/income', url: 'https://joeeeee28.github.io/Planner/#/money/income', stored: '{"onboarded":true}' },
    { name: 'onboarded, /money/expenses', url: 'https://joeeeee28.github.io/Planner/#/money/expenses', stored: '{"onboarded":true}' },
    { name: 'onboarded, /money/budgets', url: 'https://joeeeee28.github.io/Planner/#/money/budgets', stored: '{"onboarded":true}' },
    { name: 'onboarded, /money/recurring', url: 'https://joeeeee28.github.io/Planner/#/money/recurring', stored: '{"onboarded":true}' },
    { name: 'onboarded, /money/history', url: 'https://joeeeee28.github.io/Planner/#/money/history', stored: '{"onboarded":true}' },
    { name: 'onboarded, /money/unknown-tab → overview fallback', url: 'https://joeeeee28.github.io/Planner/#/money/bogus', stored: '{"onboarded":true}' },
    { name: 'onboarded, /plan/quarter/2026-Q3', url: 'https://joeeeee28.github.io/Planner/#/plan/quarter/2026-Q3', stored: '{"onboarded":true}' },
    { name: 'onboarded, /reviews/quarter/2026-Q3', url: 'https://joeeeee28.github.io/Planner/#/reviews/quarter/2026-Q3', stored: '{"onboarded":true}' },
    { name: 'onboarded, /reviews/year/2026', url: 'https://joeeeee28.github.io/Planner/#/reviews/year/2026', stored: '{"onboarded":true}' },
